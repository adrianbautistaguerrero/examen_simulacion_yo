...
def predict_spam(email_text):
    ...
    Returns:
        dict: {
            ...
            'spam_keywords': list (palabras sospechosas),
    ...
    try:
        ...
        spam_trigger_words = [
            ...
            'offer', 'discount', 'save', 'money', 'credit', 'loan', 'debt',
            'viagra', 'pharmacy', 'pills', 'medicine', 'drug', 'weight', 'loss',
            'guarantee', 'limited', 'urgent', 'act now', 'call now', 'order now',
            'congratulations', 'selected', 'claim', 'risk free', 'no cost',
            'investment', 'income', 'profit', 'earn', 'make money', 'business',
            'opportunity', 'mlm', 'marketing', 'promotion', 'deal', 'cheap'
        ]
        
        # Find which trigger words appear in the cleaned text
        found_keywords = []
        ...
        return {
            ...
            'spam_keywords': found_keywords[:10],  # Limit to top 10
